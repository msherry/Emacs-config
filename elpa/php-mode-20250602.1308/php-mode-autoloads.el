...
runs the hook `php-base-mode-hook', as the final or penultimate step during
initialization.
...
In addition to any hooks its parent mode `php-base-mode' might have run, this
mode runs the hook `php-mode-hook', as the final or penultimate step during
initialization." t)
