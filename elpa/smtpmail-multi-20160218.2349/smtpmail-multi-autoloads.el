;;; smtpmail-multi-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
Send mail using smtp server selected by the `smtpmail-multi-select' function." nil nil)

(register-definition-prefixes "smtpmail-multi" '("smtpmail-multi-"))
