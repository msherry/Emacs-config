...
If called interactively, toggle `Org-Indent mode'.  If the prefix argument is
...
If called interactively, toggle `Org-List-Checkbox-Radio mode'.  If the prefix
argument is positive, enable the mode, and if it is zero or negative, disable
the mode.
...
If called interactively, toggle `Org-Num mode'.  If the prefix argument is
positive, enable the mode, and if it is zero or negative, disable the mode.
...
If called interactively, toggle `Org-Table-Header-Line mode'.  If the prefix
argument is positive, enable the mode, and if it is zero or negative, disable
the mode.
...
If called interactively, toggle `OrgTbl mode'.  If the prefix argument is
positive, enable the mode, and if it is zero or negative, disable the mode.
...
If called interactively, toggle `Org-Beamer mode'.  If the prefix argument is
positive, enable the mode, and if it is zero or negative, disable the mode.
