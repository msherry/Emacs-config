...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "slime-cl-indent" '("common-lisp-" "define-common-lisp-style" "lisp-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "slime-references" '("sldb-maybe-insert-references" "slime-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "slime-repl" '("?r" "defslime-repl-shortcut" "nil" "sldb-" "slime-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "bridge" '("bridge-" "hand-bridge" "install-bridge" "remove-bridge" "reset-bridge")))
