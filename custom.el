...
%a" :empty-lines-after 1 :clock-in t :clock-resume t)))
 ...
 '(package-selected-packages
   '(ac-geiser ack arduino-cli-mode arduino-mode auctex auto-minor-mode bazel-mode blacken cargo cider clojure-mode clojure-mode-extra-font-locking common-lisp-snippets counsel diff-hl dockerfile-mode dtrace-script-mode el2markdown elpy emojify ess esup exec-path-from-shell feature-mode find-find-in-project flx flx-ido flycheck-clojure flycheck-ocaml flycheck-package flycheck-pycheckers flycheck-rust fxrd-mode geiser geiser-guile geiser-racket git-modes go-mode graphviz-dot-mode groovy-mode helm-projectile httpcode ivy jedi json-mode latex-preview-pane magit magithub markdown-preview-mode notmuch org-agenda-property org-jira org-mru-clock org-plus-contrib org-pomodoro org-super-agenda ox-gfm package-lint paredit php-mode pinentry projectile protobuf-mode pymacs python-mode racer racket-mode rainbow-mode realgud-ipdb rmsbolt rust-mode sass-mode slime smtpmail-multi solarized-theme suggest swift-mode tagedit thrift tickscript-mode tuareg virtualenv which-key window-numbering yaml-mode yasnippet-snippets))
 ...
 '(safe-local-variable-values
   '((arduino-cli-default-fqbn . "arduino:avr:nano:cpu=atmega328old")
     ...
     (arduino-cli-default-port . "/dev/cu.usbmodel1421")
